...
class ImageZoomInTool(BaseTool):
    ...
    def _maybe_resize_bbox(self, bbox_2d: list[float], image_width: int, image_height: int) -> Optional[list[float]]:
        ...
        abs_x1, abs_y1, abs_x2, abs_y2 = rel_x1 / 1000. * image_width, rel_y1 / 1000. * image_height, rel_x2 / 1000. * image_width, rel_y2 / 1000. * image_height

        current_bbox = [abs_x1, abs_y1, abs_x2, abs_y2]
        ...
        if height < self.MIN_DIMENSION or width < self.MIN_DIMENSION:
            ...
            center_x = (abs_x1 + abs_x2) / 2.0
            center_y = (abs_y1 + abs_y2) / 2.0
